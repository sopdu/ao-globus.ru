                                    ...
                                    switch ($blockName)
                                    {
                                        ...
                                        case 'price':
                                            ...
                                            <div class="product-item-detail-info-container">
                                                ...
                                                <div class="price_productp text-center" id="<?=$itemIds['PRICE_ID']?>">
                                                    <?=explode(' ', $price['PRINT_RATIO_PRICE'])[0]?>₽/уп
                                                    <?#=$price['PRINT_RATIO_PRICE']?>
                                                    <?#='<pre>'; print_r($price); '</pre>';?>
                                                </div>
                                                <?
                                                if ($arParams['SHOW_OLD_PRICE'] === 'Y')
                                                {
                                        ...
                                        case 'buttons':
                                            ...
                                            <div data-entity="main-button-container">
                                                <div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
                                                    ...
                                                    if ($showAddBtn)
                                                    {
                                                        ...
                                                        <div class="product-item-detail-info-container">
                                                            ...
                                                            <a class="price_productp_to_cart" id="<?=$itemIds['ADD_BASKET_LINK']?>"
                                                    ...
                                                    if ($showBuyBtn)
                                                    {
                                                        ...
                                                        <div class="product-item-detail-info-container">
                                                            ...
                                                            <a class="price_productp_to_cart" id="<?=$itemIds['BUY_LINK']?>"
                                                               href="javascript:void(0);">
                                                    ...
                                                    <div class="product-item-detail-info-container">
                                                        ...
                                                        $APPLICATION->IncludeComponent(
                                                            ...
                                                            array(
                                                                ...
                                                                'BUTTON_CLASS' => 'price_productp_to_cart',
                                                ...
                                                <div class="product-item-detail-info-container">
                                                    ...
                                                    <a class="price_productp_to_cart" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>"
                                                       href="javascript:void(0)"
				...
				<tr>
					...
					if ($showAddBtn)
					{
						...
						<td rowspan="2" class="product-item-detail-short-card-btn"
							...
							<a class="price_productp_to_cart"
					...
					<td rowspan="2" class="product-item-detail-short-card-btn"
						...
						<a class="price_productp_to_cart" href="javascript:void(0)"
							rel="nofollow">
							<?=$arParams['MESS_NOT_AVAILABLE']?>
						</a>
					</td>
