...
<div class="container">
    <div class="d-flex justify-content-between">
        ...
        <span class="preview_title_box text-body mt60 book mb-5;" style="white-space:nowrap; margin-bottom: 30px;"><?=GetMessage("PopularProduct")?></span>
        <div class="line smallline"></div>
    </div>
					...
					case 2:
						?>
								...
								foreach ($rowItems as $item)
								{
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-6 p-1 p-lg-2">
												<?
												$APPLICATION->IncludeComponent(
													'bitrix:catalog.item',
													'index_page',
