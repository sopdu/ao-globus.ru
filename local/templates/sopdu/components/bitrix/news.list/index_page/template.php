...
<div class="container news_line_wrapper d-flex justify-content-between">
    <div class="line"></div>
    <span class="preview_title_box text-body mt60 book mb-5"><?=GetMessage("NEWS_TITLE")?></span>
    <div class="line"></div>
</div>
<div class="container">
    <div class="row news_wrapper">
        <?foreach($arResult["ITEMS"] as $arItem):?>
            ...
            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="news_item col-3" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                ...
                <div class="news_date">
                    <?
                        $exp = explode(' ', $arItem["TIMESTAMP_X"]);
                        echo $exp[0];
                    ?>
                </div>
            </a>
...
<div class="line w-100 d-none d-md-block"></div>