...
<div class="d-flex justify-content-between"  id="<?=$itemIds['ID']?>">
	<div class="productpage_preview">
		...
		<div class="adaptation_block">
			...
			<div class="price_productp text-center mt-4 mb-5"><?=explode(' ', $arResult["MIN_PRICE"]["PRINT_VALUE"])[0]?>₽/ед</div>


				<div style="flex-wrap: wrap;" class="cart_price_productp d-flex justify-content-center">
					<div class="subtract col-2 ">-</div>
	             	<input type="number" min="1" value="1" class="amount col-2">
	             	<div class="add col-2 ">+</div>
	             	<div class="to-cart col-12 mt-2" data-value="<?= $arResult['ADD_URL'];?>">В корзину</div>
				</div>
            <?endif?>
		...
		<div class="stickyfor inner" id="fixed">
			...
			<div class="cart_price_productp d-flex justify-content-center adaptation_none">
				<div class="subtract col-2 ">-</div>
             	<input type="number" min="1" value="1" class="amount col-2">
             	<div class="add col-2 ">+</div>
             	<div class="to-cart col-6" data-value="<?= $arResult['ADD_URL'];?>">В корзину</div>
			</div>
    ...
    <div class="productpage_specs m0auto row d-flex justify-content-between p-2 flex-nowrap text-nowrap" >
    	<div class="w-100">
    		...
    		<div class="cart_inner">
                ...
                <div class="to-cart col-6" data-value="/?back_url_admin=%2Fbitrix%2Fadmin%2F&amp;action=ADD2BASKET&amp;id=125">
                	В корзину
                </div>
            </div>
        </div>
...
<?#='<pre>'; print_r(explode(' ', $arResult["MIN_PRICE"]["PRINT_VALUE"])[0]); '</pre>';?>
...
<script>
	$('.add').click(function() {
		const input = $(this).closest(".cart_inner").find("input");
...
*/?>
<?#='<pre>'; print_r($arResult["MIN_PRICE"]); '</pre>';?>
<?php/*
