...
<div class="d-flex justify-content-between" id="<?=$itemIds['ID']?>">
	<div class="productpage_preview">
		...
		<img class="img_p_page" src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" width="657px" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>" />
		<div class="product_photos d-flex justify-content-betwee adaptation_none">
            <?if(!empty($arResult["PROPERTIES"]["MORE_PHOTO"]["VALUE"])):?>
                <?foreach ($arResult["PROPERTIES"]["MORE_PHOTO"]["VALUE"] as $morePhoto):?>
                    <img class="ml-4" src="<?=CFile::GetPath($morePhoto)?>" width="97px" />
                <?endforeach;?>
            <?endif;?>
        </div>
        <div class="adaptation_block">
        	...
        	<div class="price_productp text-center mt-4 mb-5"><?=explode(' ', $arResult["MIN_PRICE"]["PRINT_VALUE"])[0]?>₽/уп</div>
