...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" class="bx-soa-wrapper m-0" id="bx-soa-order-form" enctype="multipart/form-data">
		<?
		...
		<div id="bx-soa-order" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="bx-soa">
				<div class="d-none" id="bx-soa-main-notifications">
					<div class="alert alert-danger" style="display:none"></div>
					<div data-type="informer" style="display:none"></div>
				</div>
				<!--	AUTH BLOCK	-->
				<div id="bx-soa-auth" class="d-none bx-soa-section bx-soa-auth" style="display: none;">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="d-none bx-soa-section bx-active">
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" data-visited="false" class="d-none bx-soa-section bx-active">
					<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
						<div class="bx-soa-section-title" data-entity="section-title">
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="d-none bx-soa-section bx-active">
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
					...
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" class="d-none bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
					...
					<!--	PICKUP BLOCK	-->
					<div id="bx-soa-pickup" data-visited="false" class="d-none bx-soa-section" style="display:none">
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
								<span class="bx-soa-section-title-count"></span>
							</div>
				...
				<? endif ?>
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="d-none bx-soa-section bx-active">
					<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
						<div class="bx-soa-section-title" data-entity="section-title">
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave" class="d-block text-center">
					<a href="javascript:void(0)" style="margin: 10px 0" class="basket_order_btn d-flex justify-content-center" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div class="d-none" id="bx-soa-total">
