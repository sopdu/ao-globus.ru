        ...
        <div class="lowcontainer" id="adapt_none_head">
            <div class="d-flex adaptation_block fixjcsb">
                <div class="row center" style="text-align: center">
                    ...
                    <img src="<?=$this->GetFolder()?>/Vector.png" style="margin-top: 0; margin-left: 0" />
                </div>
                    <div style="width: 100%; padding: 15px" class="cont_title text-center">
...
<?else:?>
    <div class="about_title text-body mb-5">Поиск по запросы: <?=$_GET["q"]?></div>
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		...
		<?if (
			...
			<div class="search-item-rate" style="border-radius: 1px  red"><?
				$APPLICATION->IncludeComponent(
